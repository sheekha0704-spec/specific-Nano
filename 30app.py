...
# Handle Navigation first to determine where to show the uploader
...
if nav == "Step 1: Sourcing":
    ...
    # Industrial Work: Browse CSV moved to main screen
    ...
    if df is not None:
        ...
        with c_top2:
            # SMILES changed to manual type-in only
        ...
        st.error("Please ensure 'nanoemulsion 2.csv' is available or upload a CSV file.")

else:
    # Ensure data is loaded for subsequent steps if not on Step 1
    df = load_and_clean_data()

# --- AI ENGINE & OTHER STEPS (UNTOUCHED) ---
@st.cache_resource
